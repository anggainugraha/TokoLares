			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
							<img src="../tokolares/gambar/logo.jpg" alt="">
						</a>
					</div>
					<!-- /footer logo -->

					<p>Toko online Lares penyedia frozen food, tersedia berbagai pilihan dengan kualitas terbaik.</p>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<li><a href="tentang.php">About</a></li>
						<li><a href="proses_ulasan.php">Ulasan Pengguna</a></li>
					</ul>
				</div>
			</div>
			<!-- /footer widget -->
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<ul class="footer-social">
						<li><a href="https:/wa.me/+6287784713113"><i class="fa fa-whatsapp"></i></a></li>
